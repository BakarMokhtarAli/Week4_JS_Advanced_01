...
let allCaps = runners.map(function(item){
    return item.first_name.toUpperCase() + item.last_name
})
console.log(allCaps); 
...
let totalDonations = runners.reduce((acc,currenValue)=>{
    return acc + currenValue.donation
},0)
